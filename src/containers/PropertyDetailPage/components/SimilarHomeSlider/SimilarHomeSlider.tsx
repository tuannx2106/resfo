...
import { testPropertyItems } from 'containers/PropertyDetailPage/helpers'
import React, { useState } from 'react'
import { Swiper as Slider, SwiperSlide } from 'swiper/react'
import Swiper from 'swiper/types/swiper-class'
import s from './SimilarHomeSlider.module.scss'

const SimilarHomeSlider = () => {
  const [sliderInstance, setSliderInstance] = useState<Swiper | null>(null)

  return (
    <div className={s.root}>
      <Slider onSwiper={setSliderInstance} className={s.similarHomeSlider} spaceBetween={16} slidesPerView="auto">
        {testPropertyItems.map((propertyItem) => (
...
export default SimilarHomeSlider
